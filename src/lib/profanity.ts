...
const BASE_WORDS = [
  // PL
  "kurwa", "kurwy", "chuj", "chuja", "chuje", "chujc", "huj", "pizda", "pizdy", "jebac", "jebać",
  "jebany", "jebana", "jebane", "pierdol", "pierdole", "pierdolony", "spierdalaj", "wypierdalaj",
  "skurwysyn", "kutas", "cipa", "cipka", "dupek", "debil", "idiota", "zjeb", "zajebisty" ,"pedal",
  "pedał", "cwel", "szmata", "dziwka", "kurewsk", "gowno", "gówno", "srac", "srać", "napierdal",
  // EN
  "fuck", "fucking", "fucker", "motherfucker", "shit", "bullshit", "bitch", "cunt", "asshole",
  "dick", "pussy", "whore", "slut", "bastard", "nigger", "nigga", "faggot", "rape", "retard",
];
